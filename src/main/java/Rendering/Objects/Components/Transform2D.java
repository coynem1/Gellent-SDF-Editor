...
public class Transform2D <T> extends Component {
    ...
    public void setRotation(float rotation) {this.rotation = rotation; InputShapesEvents.setRotationCallback(rotation);}
    public void setScale(float scale) {this.scale = scale; InputShapesEvents.setScaleCallback(scale);}
